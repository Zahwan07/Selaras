    ...
    <main>
        ...
        <div class="courses-area section-padding40 fix">
            <div class="container">
                ...
                <form action="/komplain" method="POST" role="form">
                    @csrf
                    <div class="form-group">
                        <label for="nama">Nama</label>
                        <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama Lengkap kamu">
                      </div>
                      <div class="form-group">
...
<script>
    function previewImage() {
      const gambarBukti = document.getElementById("gambar");
      const previewGambar = document.getElementById("preview-gambar");

      if (gambarBukti.files && gambarBukti.files[0]) {
        const reader = new FileReader();

        reader.onload = function() {
          previewGambar.src = reader.result;
        };

        reader.readAsDataURL(gambarBukti.files[0]);
      } else {
        previewGambar.src = "";
      }
    }
